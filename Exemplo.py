...
class Almoxarifado:
    ...
    def carregar_dados(self):
        if os.path.exists(self.caminho_arquivo):
            ...
            # Criar 20 itens de exemplo diversificados
            import random
            itens_exemplo = [
                (101, "Monitor 24'", "Eletrônicos", "#3498db"), (102, "Teclado Mecânico", "Periféricos", "#e74c3c"),
                (103, "Mouse Gamer", "Periféricos", "#2ecc71"), (104, "Cadeira Office", "Móveis", "#f1c40f"),
                (105, "Notebook i7", "Eletrônicos", "#9b59b6"), (106, "Cabo HDMI 2m", "Acessórios", "#34495e"),
                (107, "Grampeador", "Papelaria", "#e67e22"), (108, "Resma Papel A4", "Papelaria", "#95a5a6"),
                (109, "Furadeira Impacto", "Ferramentas", "#1abc9c"), (110, "Jogo de Chaves", "Ferramentas", "#d35400"),
                (111, "HD Externo 1TB", "Armazenamento", "#2980b9"), (112, "Pendrive 64GB", "Armazenamento", "#27ae60"),
                (113, "Mesa em L", "Móveis", "#8e44ad"), (114, "Luminária LED", "Decoração", "#f39c12"),
                (115, "Projetor 4K", "Eletrônicos", "#c0392b"), (116, "Webcam Full HD", "Periféricos", "#16a085"),
                (117, "Fone com Mic", "Áudio", "#7f8c8d"), (118, "Caixa de Som BT", "Áudio", "#2c3e50"),
                (119, "Quadro Branco", "Escritório", "#bdc3c7"), (120, "Canetas (Pacote)", "Papelaria", "#f1948a")
            ]
            
            dados_lista = []
            for id_item, nome, cat, cor in itens_exemplo:
                dados_lista.append({
                    "ID": id_item,
                    "Produto": nome,
                    "Categoria": cat,
                    "Qtd_Atual": random.randint(2, 50),
                    "Qtd_Minima": random.randint(5, 10),
                    "Preco_Unitario": round(random.uniform(15.0, 2500.0), 2),
                    "Cor_Hex": cor
                })
